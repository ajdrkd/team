...
<body>
    ...
    <div id="contents">
        ...
        <div id="prodct-img-ex_wrap">
            <img src="/resources/upload/${goodDetailData.uploadPath3}/${goodDetailData.uuid3}_${goodDetailData.fileName3}" alt="" class="prodct-img-ex prodct-img-ex_01">
            <!--  <img src="/resources/upload/${goodDetailData.uploadPath4}/${goodDetailData.uuid4}_${goodDetailData.fileName4}" alt="" class="prodct-img-ex prodct-img-ex_02">-->
        </div>
		<div id="review_wrap">
			<table>
				<thead>
